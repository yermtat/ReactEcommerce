...
export default function Footer() {
  return (
    <div class="px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen md:px-24 lg:px-8 border-t">
      <div class="grid gap-10 row-gap-6 mb-8 sm:grid-cols-3 lg:grid-cols-5">
